...
enyo.path.addPaths({layout: "C://Users/Jordan/workspace/frequency/enyo/tools/../../lib/layout/", onyx: "C://Users/Jordan/workspace/frequency/enyo/tools/../../lib/onyx/", onyx: "C://Users/Jordan/workspace/frequency/enyo/tools/../../lib/onyx/source/"});
...
classes: "onyx-toolbar-fix button-container",
components: [ {
kind: "onyx.Button",
content: "Study Assets",
ontap: "studyAssets",
classes: "onyx-button-dark",
style: "width: 100%"
}, {
tag: "br"
}, {
...
kind: "onyx.Button",
content: "Perform A Study",
ontap: "performStudy",
classes: "onyx-affirmative",
style: "background-color: #236300; width: 100%;"
} ]
} ],
...
content: "Categories",
style: "text-align: center; text-indent: -50px;",
fit: !0
}, {
kind: "onyx.IconButton",
src: "assets/menu-icon-add.png",
style: "height: 32px"
} ]
}, {
kind: "List",
...
rendered: function() {
this.inherited(arguments), this.$.Cat.setCount(100);
},
setupItem: function(a, b) {
this.$.name.setContent(b.index);
},
goBack: function() {
this.bubble("onHome");
}
